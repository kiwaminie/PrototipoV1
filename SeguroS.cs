    ...
    public partial class SeguroS : Form
    {
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (con.Registrado_Ss(Convert.ToInt32(textBox1.Text)) == 0)
                    {
                        MessageBox.Show(con.Insertar_Ss(Convert.ToInt32(textBox1.Text), fecha_In.Value.ToString("dd/MM/yyyy"), fecha_Fn.Value.ToString("dd/MM/yyyy")));
                        con.Cargar_Ss(dataGridView1);
                        textBox1.Text = "";
                    }
                    else
                    {
